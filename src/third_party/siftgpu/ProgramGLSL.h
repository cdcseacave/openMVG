...
public:
    ...
    virtual void * GetProgramID() { return reinterpret_cast<void*>((size_t)_programID); }
public:
	ProgramGLSL();
	~ProgramGLSL();
...
public:
	...
	virtual void SetDogThreshold(float dog_threshold, float edge_threshold) = 0;
...
class ShaderBagGLSL:public ShaderBag
{
	...
	GLint _param_dog_threshold0;
	GLint _param_dog_threshold1;
	GLint _param_dog_threshold2;
...
public:
	...
	virtual void SetDogThreshold(float dog_threshold, float edge_threshold);
