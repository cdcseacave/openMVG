...
private:
	...
	const char*			_title;
	std::vector<char>	_record_definition;
	std::vector<RecordLoc*>	_match_records;
private:
...
public:
	...
	void CloseMatchFile();
	void GetMatchedImageList(std::vector<std::string>& paths);
    void SaveSubsetMatch(std::vector<std::string>& paths, std::vector<int>& fc);
...
public:
	////////////////////static functions
	static void WriteIMatch(const char* image1, const char* image2, int NM, TwoViewGeometry& tvg, Points<int>& inliers, bool noReverse=false);
	static void WriteIMatch(MatchFile* mat, const char* image1, const char* image2, int NM, TwoViewGeometry& tvg, Points<int>& inliers);
	static void WritePMatch(const char* image1, const char* image2, int fc1, int fc2, int NM, Points<int>& matches, bool noReverse=false);
	static void WriteFMatch(const char* image1, const char* image2, int NF,	int * index1, int * index2, float F[3][3]);
	///////////////////////////////////////
